...
Pytorch implementation for the SIDU by Muddamsetty et al. (2021).
...
References:
    ...
    Introducing and assessing the explainable AI method: Sidu. arXiv preprint
    arXiv:2101.10710.
...
def sidu(
    ...
    with torch.no_grad():
        ...
        sal_map = weighted_fams_tensor / len(weights) / 0.5  # from the oficial TF implementation
